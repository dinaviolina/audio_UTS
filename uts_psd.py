...
import pickle
st.title("Aplikasi Streamlit Deteksi Audio")
st.write("Dina Violina")
st.write("210411100004")
st.write("PSD B")

# Fungsi untuk menghitung statistik audio
def calculate_statistics(audio):
...
if uploaded_file is not None:
    ...
    if st.button("Deteksi Audio"):
        ...
        st.write("Emosi dideteksi dengan (ZScore):", label_emosi_zscore)
        st.write("Emosi dideteksi dengan (MinMax):", label_emosi_minmax)
